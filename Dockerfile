...
RUN   /sbin/setuser alfresco ./alfresco-community-5.0.d-installer-linux-x64.bin --mode unattended --alfresco_admin_password admin --disable-components alfrescogoogledocs
RUN   rm ./alfresco-community-5.0.d-installer-linux-x64.bin
...
RUN   mv /alfrescotrashcancleaner2.amp /home/alfresco/alfresco-5.0.d/amps
COPY  protectnodes.amp /
RUN   mv /protectnodes.amp /home/alfresco/alfresco-5.0.d/amps
# apply amps
COPY  apply_amps_unatended.sh /
RUN   chmod +x /apply_amps_unatended.sh
RUN   mv /apply_amps_unatended.sh /home/alfresco/alfresco-5.0.d/bin
RUN   /home/alfresco/alfresco-5.0.d/bin/apply_amps_unatended.sh
