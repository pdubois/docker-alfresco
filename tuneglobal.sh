...
# test if varvalue already configured in alfresco-global.properties
     if grep -q ^$name /home/alfresco/alfresco-5.0.d/tomcat/shared/classes/alfresco-global.properties
     then
        sed -i "/home/alfresco/alfresco-5.0.d/tomcat/shared/classes/alfresco-global.properties" -e "s/$name=.*/$name=$varvalue/g"
    else
        echo  "$name=$varvalue" >> "/home/alfresco/alfresco-5.0.d/tomcat/shared/classes/alfresco-global.properties"
    fi
 fi
done
